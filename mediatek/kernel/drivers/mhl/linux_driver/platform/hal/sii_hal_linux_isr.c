...
#include <cust_eint.h>
/*
#if !defined GPIO_HDMI_EINT
#error GPIO_HDMI_EINT not defined
#endif
*/
#if !defined CUST_EINT_HDMI_HPD_NUM
#error CUST_EINT_HDMI_HPD_NUM not defined
#endif
...
#if 0
	mt_set_gpio_mode(GPIO_HDMI_EINT, GPIO_MODE_01);
	mt_set_gpio_dir(GPIO_HDMI_EINT, GPIO_DIR_IN);
	mt_set_gpio_pull_select(GPIO_HDMI_EINT,  GPIO_PULL_UP);
    mt_set_gpio_pull_enable(GPIO_HDMI_EINT, true);
#endif
