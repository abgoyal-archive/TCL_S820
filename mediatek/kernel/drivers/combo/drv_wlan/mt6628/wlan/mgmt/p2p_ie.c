    ...
    )
{
    ...
    do {
       ...
       //PR377531 porting P224_JRD377531_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P224_.tar.gz patch begin
       //PR389153-Hualan su update MTK patch for PR377531 Add begin
        // ADD HT Capability
        u4RetValue += (ELEM_HDR_LEN + ELEM_MAX_LEN_HT_CAP);

        // ADD WMM Information Element
        u4RetValue += (ELEM_HDR_LEN + ELEM_MAX_LEN_WMM_INFO);
       //PR389153-Hualan su update MTK patch for PR377531 Add end
        //PR377531 porting P224_JRD377531_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P224_.tar.gz patch end
    }while (FALSE);
