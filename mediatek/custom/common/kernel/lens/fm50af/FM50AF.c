...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("FM50AF", 0x58)};
...
static void FM50AF_GpioEnable(int enable)
{
...
static int FM50AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    g_pstFM50AF_I2Cclient->addr = 0x18 >> 1;
...
static int __init FM50AF_i2C_init(void)
{
	...
	FM50AFDB("xxxxxFM50AF_i2C_init called xxxx\n");
