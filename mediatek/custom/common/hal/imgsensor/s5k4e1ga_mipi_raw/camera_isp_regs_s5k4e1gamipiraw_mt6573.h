...
Shading:{
    {set:{//00 Preview
	    ...
	    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x10000000, 0x506a6044, 0x4000f800, 0x00680045, 0x20202020
	    	
    }},
    {set:{//01 Capture

			0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x10000000, 0x70a86090, 0x4000f800, 0x006a0063, 0x20202020
...
Saturation:{
    ...
    {set:{//04                                      // middle saturation
        0x00010709,	0x1020E0F0,	0x1A232D40,	0x40000000,	0xFF00FF00,	0x40302000,	0x00000000,	0x00783C1E
    }},
...
CCM:{
    {set:{//00
				0x00338F84,0x008B2803,	0x00019433
    }},
    {set:{//01
				0x003E9985,	0x008B2803,	0x00029735
    }},
    {set:{//02
        0x003B9685,	0x00862781,	0x0004922E
    }}
},
Gamma:{
    {set:{//00
