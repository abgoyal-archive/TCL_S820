...
#ifndef _ISPIF_MT6573_
#define _ISPIF_MT6573_
...
typedef struct {
    MUINT32 RESERVED01       : 28; //[27:0] unused
    MUINT32 SHADING_EN       : 1; //[28]
    MUINT32 SDBLK_TRIG       : 1; //[29]
    MUINT32 RESERVED1        : 2; //[31:30] unused
} ISP_SHADING_CTRL1_T;
//
...
typedef struct {
    ...
    MUINT32 CT_EN            : 1; //[1]
    MUINT32 NR_EN            : 1; //[2]
    MUINT32 BEN              : 1; //[3]     unused
    MUINT32 BMD              : 1; //[4]     unused
    MUINT32 BOP              : 1; //[5]     unused
    MUINT32 CT_MD            : 2; //[7:6]
...
//
//NR2_CFG_C1 CAM+0504H (new)
typedef struct {
    MUINT32 Y_DP_MIN_TH     : 5; //[4:0]        5
    MUINT32 RESERVED3       : 3; //[7:5]        unused
    MUINT32 Y_DP_MAX_TH     : 5; //[12:8]       5
    MUINT32 RESERVED4       : 2; //[14:13]      unused
    MUINT32 Y_DP_EN         : 1; //[15]         1
    MUINT32 YUV444_MODE     : 1; //[16]         1
    MUINT32 RESERVED5       : 3; //[19:17]      unused
    MUINT32 QEC             : 1; //[20]         1
...
typedef struct {
    MUINT32 DISLJ            : 1; //[0]     0
    MUINT32 VLEDGEN          : 1; //[1]     unused
    MUINT32 RESERVED0        : 3; //[4:2]   unused
    MUINT32 HLEDGEN          : 1; //[5]     unused
...
typedef struct {
    MUINT32 THRE_LEDGE       : 7; //[6:0]   unused
    MUINT32 RESERVED7        : 1; //[7]     unused
    MUINT32 LINE_RBTHD       : 5; //[12:8]  B'00100
    MUINT32 RESERVED8        : 3; //[15:13] unused
    MUINT32 NYQ_TH           : 7; //[22:16] B'0011111
    MUINT32 RESERVED9        : 9; //[31:23] unused
} ISP_INTER2_T;

//
//CAM_EDGCORE CAM+007CH
typedef struct {
...
typedef struct {
    ...
    MUINT32 OPRGM_IVT        : 1; //[4]     unused
    MUINT32 RESERVED12       : 2; //[6:5]   unused
    MUINT32 BYPGM            : 1; //[7]     unused
...
typedef struct {
    ...
    MUINT32 RGBEDGE_EN       : 1; //[1]     unused
    MUINT32 CLIP_OVER_EN     : 1; //[2]     0
    MUINT32 CLIP_UNDER_EN    : 1; //[3]     0
    MUINT32 FILTER_SEL       : 1; //[4]     0
    MUINT32 ED_GM_EN         : 1; //[5]     1
    MUINT32 ED_BAND_EN       : 1; //[6]     unused ([MT6573 Camera Interface1.doc] Please always set this control register to 0)
    MUINT32 RESERVED14       : 1; //[7]     unused
    MUINT32 CLIP_OVER_TH     : 8; //[15:8]  H'24
    MUINT32 CLIP_UNDER_TH    : 8; //[23:16] H'64
    MUINT32 ED_GAIN_TH       : 8; //[31:24] H'20
} ISP_EE_CTRL_T;
//
//ED_LUT_X CAM+0234H
typedef struct {
    MUINT32 ED_LUT_X1        : 8; //[7:0]   H'04
    MUINT32 ED_LUT_X2        : 8; //[15:8]  H'07
    MUINT32 ED_LUT_X3        : 8; //[23:16] H'0A
    MUINT32 RESERVED15       : 8; //[31:24] unused
} ISP_ED_LUT_X_T;
//
//ED_LUT_Y CAM+0238H
typedef struct {
    MUINT32 ED_LUT_Y1        : 8; //[7:0]   H'02
    MUINT32 ED_LUT_Y2        : 8; //[15:8]  H'04
    MUINT32 ED_LUT_Y3        : 8; //[23:16] H'08
    MUINT32 ED_LUT_Y4        : 8; //[31:24] H'16
} ISP_ED_LUT_Y_T;
//
//EGAMMA1 CAM+05A0H
typedef struct {
...
//
//CAM_MATRIX1 CAM+009CH
typedef struct {
    MUINT32 M13              : 8; //[7:0]   H'80
    MUINT32 M12              : 8; //[15:8]  H'80
    MUINT32 M11              : 8; //[23:16] H'20
    MUINT32 RESERVED0        : 8; //[31:24] unused
} ISP_CCM1_T;
//
//CAM_MATRIX2 CAM+00A0H
typedef struct {
    MUINT32 M23              : 8; //[7:0]   H'80
    MUINT32 M22              : 8; //[15:8]  H'20
    MUINT32 M21              : 8; //[23:16] H'80
    MUINT32 RESERVED1        : 8; //[31:24] unused
} ISP_CCM2_T;
//
//CAM_MATRIX3 CAM+00A4H
typedef struct {
    MUINT32 M33              : 8; //[7:0]   H'80
    MUINT32 M32              : 8; //[15:8]  H'80
    MUINT32 M31              : 8; //[23:16] H'20
    MUINT32 RESERVED2        : 8; //[31:24] unused
} ISP_CCM3_T;
...
typedef union {
    ...
    enum { DEFAULT  = 0x000000A0 }; //0x000000C8
...
typedef union{
    ...
    struct {
        ...
        ISP_NVRAM_NR1_NR_EDGE0_T    nr_edge0;   //  (new)
        ISP_NVRAM_NR1_NR_EDGE1_T    nr_edge1;   //  (new)
    };
} ISP_NVRAM_NR1_T;
...
typedef union{
    ...
    struct {
        ...
        ISP_NVRAM_NR2_MODE1_CFG2_T      mode2_cfg2;     // (new)
        ISP_NVRAM_NR2_MODE1_CFG3_T      mode3_cfg3;     // (new)
    };
} ISP_NVRAM_NR2_T;
...
typedef union {
    //EE_CTRL CAM+0230H
    enum { MASK     = 0xFFFFFF1D };
    enum { DEFAULT  = 0x20642400 };
...
typedef union {
    //ED_LUT_X CAM+0234H
    enum { MASK     = 0x00FFFFFF };
    enum { DEFAULT  = 0x000A0704 };
    typedef ISP_ED_LUT_X_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ED_LUT_X_CTRL_T;
//
typedef union {
    //ED_LUT_Y CAM+0238H
    enum { MASK     = 0xFFFFFFFF };
    enum { DEFAULT  = 0x16080402 };
    typedef ISP_ED_LUT_Y_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ED_LUT_Y_CTRL_T;
//
//
typedef union{
    enum { COUNT = 4 };
    ...
    struct {
        ...
        ISP_NVRAM_ED_LUT_X_CTRL_T ed_lut_x;
        ISP_NVRAM_ED_LUT_Y_CTRL_T ed_lut_y;
    };
} ISP_NVRAM_EE_T;
...
typedef union{
    ...
    struct {
        ...
        ISP_EFFECT_ED_LUT_X_T   ed_lut_x;
        ISP_EFFECT_ED_LUT_Y_T   ed_lut_y;
    };
} ISP_EFFECT_EDGE_T;
