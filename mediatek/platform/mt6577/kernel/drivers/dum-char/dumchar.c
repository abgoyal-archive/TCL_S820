...
extern unsigned long long get_mmc_ua_size(struct msdc_host *mmc);
#endif
...
static int init_region_info(void){
	...
	User_Region_Size_Byte = get_mmc_ua_size(host);
	emmc_size = User_region_Header_Byte + User_Region_Size_Byte;
