...
//
/*=======================================================================*/
/* Lens actuator               for fm50af AF IC                                         */
/*=======================================================================*/
...
//
/*=======================================================================*/
/* Lens actuator               for dw9714 AF IC                                         */
/*=======================================================================*/
...
#define SIM_CARD1 1
#define SIM_CARD2 1
static struct platform_device sim_mt65xx_dev[] = {
#if(SIM_CARD1)
	{
		.name = "sim-mt65xx",
		.id = 0,
...
// SIM Card
//=======================================================================
	for (i = 0; i < ARRAY_SIZE(sim_mt65xx_dev); i++){
		retval = platform_device_register(&sim_mt65xx_dev[i]);
		if (retval != 0){
			printk("[%s]: failed to register sim_mt65xx_dev[%d]\n", __func__, i);
			return retval;
		}
	}
