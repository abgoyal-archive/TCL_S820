...
int l2_packet_get_own_addr_2(struct l2_packet_data *l2, u8 *addr)
{
...
int l2_packet_send_2(struct l2_packet_data *l2, const u8 *dst_addr, u16 proto,
		   const u8 *buf, size_t len)
{
	int ret;
	if (l2 == NULL)
...
static void l2_packet_receive_2(int sock, void *eloop_ctx, void *sock_ctx)
{
...
struct l2_packet_data * l2_packet_init_2(
	...
	void *rx_callback_ctx, int l2_hdr)
{
	...
	eloop_register_read_sock(l2->fd, l2_packet_receive_2, l2, NULL);

	return l2;
}


void l2_packet_deinit_2(struct l2_packet_data *l2)
{
	if (l2 == NULL)
		return;
...
int l2_packet_get_ip_addr_2(struct l2_packet_data *l2, char *buf, size_t len)
{
	int s;
	struct ifreq ifr;
...
void l2_packet_notify_auth_start_2(struct l2_packet_data *l2)
{
}
