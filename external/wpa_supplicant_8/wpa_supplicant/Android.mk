...
L_CFLAGS += -DANDROID_LOG_NAME=\"p2p_supplicant\"
...
ifndef CONFIG_L2_PACKET_2
CONFIG_L2_PACKET_2=linux2
endif

#OBJS_l2 += src/l2_packet/l2_packet_$(CONFIG_L2_PACKET_2).c
OBJS += src/l2_packet/l2_packet_$(CONFIG_L2_PACKET_2).c

ifeq ($(CONFIG_L2_PACKET_2), pcap)
...
ifeq ($(CONFIG_L2_PACKET_2), winpcap)
LIBS += -lwpcap -lpacket
LIBS_w += -lwpcap
endif

ifeq ($(CONFIG_L2_PACKET_2), freebsd)
LIBS += -lpcap
endif
...
ifdef CONFIG_SMARTCARD
ifndef CONFIG_NATIVE_WINDOWS
ifneq ($(CONFIG_L2_PACKET_2), freebsd)
LIBS += -ldl
endif
endif
endif
...
ifdef CONFIG_INTERNAL_SHA256_2
