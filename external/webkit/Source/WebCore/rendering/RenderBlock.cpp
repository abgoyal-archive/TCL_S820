...
//PR380084-lilei-porting P88_JRD374294_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P88_.tar.gz-begin
#include "HTMLSelectElement.h"
//PR380084-lilei-porting P88_JRD374294_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P88_.tar.gz-end
#include "HTMLNames.h"
...
//PR380084-lilei-porting P88_JRD374294_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P88_.tar.gz-begin
    /// M: fix Youtube NE @{
    ///  child->setStyle will trigger styleDidChnage -> childBecameNonInline -> removeLeftOverAnonymos
...
//PR380084-lilei-porting P88_JRD374294_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P88_.tar.gz-begin
   ...
   //     rects.append(IntRect(tx, ty, width(), height()));
        ...
        /// M: [ALPS00399601] a focusd node included a emtpy node with size. @{
        ///    skip this case.
        if (hasOverflowClip() || hasControlClip()
                || firstRootBox() || firstChild()
                || hasInlineDirectionBordersPaddingOrMargin()
                || isInlineBlockOrInlineTable() || style()->hasBackground())
            rects.append(IntRect(tx, ty, width(), height()));
        /// @}
    }
//PR380084-lilei-porting P88_JRD374294_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P88_.tar.gz-end
